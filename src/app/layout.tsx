...
export const metadata: Metadata = {
  title: "Frontend | Framer Motion",
  description: "Frontend Advance Personal Profolio",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div
          className="bg-[#fbe2e3 absolute top-[-6rem] flex-1 -z-[10] right-[11rem] rounded-full h-[32.25rem] w-[31.25rem] blur-[10rem]
         sm:w-[68.75rem] dark:bg-[#946263]"
        ></div>
        <div
          className="bg-[#dbd7fb] absolute top-[-1rem] -z-[10] flex-1 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full 

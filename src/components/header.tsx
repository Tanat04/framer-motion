  ...
  return (
    <header className="hidden md:flex items-center justify-center fixed z-[999] w-full mt-4">
      ...
      initial={{ y:-100, opacity:0 }}
        ...
        className="flex border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg shadow-black/[0.03] 
      backdrop-blur-[0.5rem] p-1 rounded-none sm:rounded-full dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75"
      >
